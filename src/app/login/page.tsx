      ...
      >
        <div className="w-full max-w-sm">
          ...
          <motion.div variants={itemVariants} className="mt-8 text-center">
            <p className="text-muted-foreground text-sm mb-3">아직 계정이 없으신가요?</p>
            <Link
              href="/signup"
              className="inline-flex items-center gap-1 px-5 py-2.5 bg-card hover:bg-muted text-foreground font-medium rounded-lg border border-border transition-colors"
            >
              회원가입
